...
#ifdef CFG_IMX_OCRAM
ADBG_SUITE_ENTRY(XTEST_TEE_1014, NULL)
#endif
ADBG_SUITE_ENTRY(XTEST_TEE_1015, NULL)
#ifdef CFG_IMX_OCOTP
ADBG_SUITE_ENTRY(XTEST_TEE_1016, NULL)
#endif
#ifdef CFG_IMX_CA_SRK
ADBG_SUITE_ENTRY(XTEST_TEE_1018, NULL)
#endif
#ifdef CFG_SNVS_MC
ADBG_SUITE_ENTRY(XTEST_TEE_1019, NULL)
#endif
