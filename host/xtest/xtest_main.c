...
#ifdef CFG_IMX_OCRAM
ADBG_SUITE_ENTRY(XTEST_TEE_1014)
#endif
ADBG_SUITE_ENTRY(XTEST_TEE_1015)
#ifdef CFG_IMX_OCOTP
ADBG_SUITE_ENTRY(XTEST_TEE_1016)
#endif
#ifdef CFG_CAAM_SM
ADBG_SUITE_ENTRY(XTEST_TEE_1017)
#endif
#ifdef CFG_IMX_CA_SRK
ADBG_SUITE_ENTRY(XTEST_TEE_1018)
#endif
#ifdef CFG_SNVS_MC
ADBG_SUITE_ENTRY(XTEST_TEE_1019)
#endif
